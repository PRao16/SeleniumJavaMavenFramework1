...
//click on proceed to checkout button
			...
			//	Enter Billing Details
				...
				driver.findElement(By.id("billing_address_1")).sendKeys("123 mainstreet");
				...
				driver.findElement(By.name("order_comments")).sendKeys("order comments");
				
				driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));
				WebElement stripelFrameElementContainer = driver.findElement(By.className("__PrivateStripeElement"));
				
				driver.switchTo().frame(stripelFrameElementContainer).findElement(By.tagName(("iframe")));
				
				WebElement cardNumber = driver.findElement(By.id("Field-numberInput"));
