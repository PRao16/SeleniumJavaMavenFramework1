...
public class Tc0004 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//3)Enter Username
		//driver.findElement(By.id("username")).sendKeys("Stu4");
		//4)Enter Email adress
		driver.findElement(By.id("username")).sendKeys("Stu4@gmail.com");
		
		//5Enter Password
		driver.findElement(By.id("password")).sendKeys("Psssw0rd@#$123452345sfsff");
