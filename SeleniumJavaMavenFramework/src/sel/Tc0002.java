...
public class Tc0002 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//3)Enter Username
		driver.findElement(By.id("reg_username")).sendKeys("dummy3");
		//4)Enter Email adress
		driver.findElement(By.id("reg_email")).sendKeys("dummy3@gmail.com");
		
		//5Enter Password
		driver.findElement(By.id("reg_password")).sendKeys("p@ssper");
